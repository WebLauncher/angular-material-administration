...
class DataAdapterService {
    ...
    upload(file) {
        const path = v4() + '_' + (file === null || file === void 0 ? void 0 : file.name);
...
function FormComponent_ng_template_2_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const field_r6 = ɵɵnextContext().field;
...
function FormComponent_ng_template_2_div_10_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("click", function FormComponent_ng_template_2_div_10_div_1_Template_button_click_5_listener() { ɵɵrestoreView(_r34); const field_r6 = ɵɵnextContext(2).field; const ctx_r32 = ɵɵnextContext(); return ctx_r32.removeImage(field_r6); });
    ɵɵtext(6, "Remove");
    ɵɵelementEnd();
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
    const field_r6 = ɵɵnextContext(2).field;
    ɵɵadvance(2);
    ɵɵtextInterpolate(field_r6 == null ? null : field_r6.label);
    ɵɵadvance(2);
...
function AddComponent_ng_container_2_mat_administration_form_12_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("save", function AddComponent_ng_container_2_mat_administration_form_12_Template_mat_administration_form_save_0_listener($event) { ɵɵrestoreView(_r7); const ctx_r6 = ɵɵnextContext(2); return ctx_r6.save($event); });
    ɵɵpipe(1, "async");
    ɵɵelementEnd();
} if (rf & 2) {
...
class AddComponent extends MetadataComponent {
...
function ListComponent_ng_container_2_table_11_ng_container_2_ng_container_1_td_2_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const element_r19 = ɵɵnextContext().$implicit;
    const column_r14 = ɵɵnextContext(2).$implicit;
...
function ListComponent_ng_container_2_table_11_td_6_button_5_Template(rf, ctx) { if (rf & 1) {
    ...
    const element_r28 = ɵɵnextContext().$implicit;
...
function ListComponent_ng_container_2_table_11_td_9_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("click", function ListComponent_ng_container_2_table_11_td_9_Template_button_click_5_listener() { ɵɵrestoreView(_r35); const element_r33 = ctx.$implicit; const ctx_r34 = ɵɵnextContext(3); return ctx_r34.delete(element_r33); });
...
function ListComponent_ng_container_2_mat_card_13_Template(rf, ctx) { if (rf & 1) {
    ...
    const metadata_r4 = ɵɵnextContext().ngIf;
...
function ListComponent_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r1 = ɵɵnextContext();
    var tmp_4_0 = null;
    const currVal_4 = (tmp_4_0 = ɵɵpipeBind1(12, 10, ctx_r1.list$)) == null ? null : tmp_4_0.length;
    var tmp_5_0 = null;
    const currVal_5 = !((tmp_5_0 = ɵɵpipeBind1(14, 12, ctx_r1.list$)) == null ? null : tmp_5_0.length);
    ɵɵadvance(1);
...
class ListComponent extends MetadataComponent {
...
function UpdateComponent_ng_container_2_mat_administration_form_21_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("save", function UpdateComponent_ng_container_2_mat_administration_form_21_Template_mat_administration_form_save_0_listener($event) { ɵɵrestoreView(_r11); const ctx_r10 = ɵɵnextContext(2); return ctx_r10.save($event); });
    ɵɵpipe(1, "async");
    ɵɵelementEnd();
} if (rf & 2) {
...
class UpdateComponent extends MetadataComponent {
    constructor(route, snackbar, router, dataAdapterService, metadata) {
        super(route, dataAdapterService, metadata);
        this.route = route;
        this.snackbar = snackbar;
...
class MaterialAdministrationModule {
...
const materialAdministrationRoutes = [
    {
